...
export const getAgencyBrands = async () => {
  ...
  _agencyBrands = await sanityClient.fetch(
    `*[_type == 'type_agencyBrand']{${agencyBrandsQuery}} | order(orderRank)`
  );
...
export const getBrandSettings_Domaine = async () => {
  ...
  _brandSettings_Domaine = await sanityClient.fetch(
    `*[_type == "type_agencyBrand" && slug.current == "/"][0]`
  );
...
export const getBrandSettings_Studio = async () => {
  ...
  _brandSettings_Studio = await sanityClient.fetch(
    `*[_type == "type_agencyBrand" && slug.current == "/studio"][0]`
  );
...
export const getFooterSettings_Domaine = async () => {
  ...
  _footerSettings_Domaine = await sanityClient.fetch(
    `*[_type == "settings_footer" && _id == "settings_footer--domaine"][0]`
  );
...
export const getFooterSettings_Studio = async () => {
  ...
  _footerSettings_Studio = await sanityClient.fetch(
    `*[_type == "settings_footer" && _id == "settings_footer--studio"][0]`
  );
...
export const getBlogPosts_Domaine = async () => {
  ...
  _blogPosts_Domaine = await sanityClient.fetch(
    `*[_type == "type_blog" && isHidden != true && agencyBrand->name == "Domaine" ]{${blogQuery} } | order( postDate desc)`
  );
...
export const getBlogPosts_Studio = async () => {
  ...
  _blogPosts_Studio = await sanityClient.fetch(
    `*[_type == "type_blog" && isHidden != true && agencyBrand->name == "Studio" ]{${blogQuery} } | order( postDate desc)`
  );
...
export const getBlogCategories_Domaine = async () => {
  ...
  _blogCategories_Domaine = await sanityClient.fetch(
    `*[_type == "type_blogCategory" && count( *[_type == "type_blog" && isHidden != true && agencyBrand->name == "Domaine" && references(^._id)] ) > 0]{ ..., slug} | order( orderRank )`
  );
...
export const getBlogCategories_Studio = async () => {
  ...
  _blogCategories_Studio = await sanityClient.fetch(
    `*[_type == "type_blogCategory" && count( *[_type == "type_blog" && agencyBrand->name == "Studio" && references(^._id)] ) > 0] | order( orderRank )`
  );
...
export const getProjects_Domaine = async () => {
  ...
  _projects_Domaine = await sanityClient.fetch(
    `*[_type == "type_project" && agencyBrand->name == "Domaine" && isHidden != true]{${projectGridFields}} | order( orderRank asc)`
  );
...
export const getProjects_Studio = async () => {
  ...
  _projects_Studio = await sanityClient.fetch(
    `*[_type == "type_project" && agencyBrand->name == "Studio" && isHidden != true]{${projectGridFields}} | order( orderRank asc)`
  );
...
export const getProjectFeatures_Domaine = async () => {
  ...
  _projectFeatures_Domaine = await sanityClient.fetch(
    `*[_type == "type_projectFeature" &&  count(*[_type == "type_project" && agencyBrand->name == "Domaine" && references(^._id)]) > 0 ]{${projectFeatureQuery} } | order( title asc)`
  );
...
export const getProjectFeatures_Studio = async () => {
  ...
  _projectFeatures_Studio = await sanityClient.fetch(
    `*[_type == "type_projectFeature" &&  count(*[_type == "type_project" && agencyBrand->name == "Studio" && references(^._id)]) > 0 ]{${projectFeatureQuery} } | order( title asc)`
  );
...
export const getPartners_Domaine = async () => {
  ...
  _partners_Domaine = await sanityClient.fetch(
    `*[_type == "type_partner" && count(*[_type == "type_project" && references(^._id) && agencyBrand->name == "Domaine"]) > 0]{${partnerTileFields}} | order(orderRank)`
  );
...
export const getPartners_Studio = async () => {
  ...
  _partners_Studio = await sanityClient.fetch(
    `*[_type == "type_partner" && count(*[_type == "type_project" && references(^._id) && agencyBrand->name == "Studio"]) > 0]{${partnerTileFields}} | order(orderRank)`
  );
...
export const getServiceTypes_Domaine = async () => {
  ...
  _serviceTypes_Domaine = await sanityClient.fetch(
    `*[_type == "type_serviceType" && 'Domaine' in agencyBrands[]->name ]{${serviceTypeQuery}} | order(orderRank)`
  );
...
export const getServiceTypes_Studio = async () => {
  ...
  _serviceTypes_Studio = await sanityClient.fetch(
    `*[_type == "type_serviceType" && 'Studio' in agencyBrands[]->name ]{${serviceTypeQuery}} | order(orderRank)`
  );
...
export const getServiceGroups_Domaine = async () => {
  ...
  _serviceGroups_Domaine = await sanityClient.fetch(
    `*[_type == "type_serviceGroup" && "/" in agencyBrands[]->slug.current]{${serviceGroupQuery}} | order(orderRank asc)`
  );
...
export const getServiceGroups_Studio = async () => {
  ...
  _serviceGroups_Studio = await sanityClient.fetch(
    `*[_type == "type_serviceGroup" && "/studio" in agencyBrands[]->slug.current]{${serviceGroupQuery}} | order(orderRank asc)`
  );
...
export const getServices_Domaine = async () => {
  ...
  _services_Domaine = await sanityClient.fetch(
    `*[_type == "type_service" && "Domaine" in agencyBrands[]->name ]{${serviceQuery}} | order(postDate desc)`
  );
...
export const getServices_Studio = async () => {
  ...
  _services_Studio = await sanityClient.fetch(
    `*[_type == "type_service" && "Studio" in agencyBrands[]->name ]{${serviceQuery}} | order(postDate desc)`
  );
...
export const getClients_Domaine = async () => {
  ...
  _clients_Domaine = await sanityClient.fetch(
    `*[_type == "type_client" && count(*[_type == "type_project" && agencyBrand->name == "Domaine" && references(^._id) ]) > 0 ]{${clientQuery}} | order(orderRank)`
  );
...
export const getClients_Studio = async () => {
  ...
  _clients_Studio = await sanityClient.fetch(
    `*[_type == "type_client" && count(*[_type == "type_project" && agencyBrand->name == "Studio" && references(^._id) ]) > 0 ]{${clientQuery}} | order(orderRank)`
  );
...
export const getClientsIndustries_Domaine = async () => {
  ...
  _clientIndustries_Domaine = await sanityClient.fetch(
    `*[_type == "type_industry" && count(*[_type == "type_project" && references(^._id) && agencyBrand->name == "Domaine"]) > 0 ]{ ..., excerpt } | order(title asc)`
  );
...
export const getClientsIndustries_Studio = async () => {
  ...
  _clientIndustries_Studio = await sanityClient.fetch(
    `*[_type == "type_industry" && count(*[_type == "type_project" && references(^._id) && agencyBrand->name == "Studio"]) > 0 ]{ ..., excerpt } | order(title asc)`
  );
...
export const getUpcomingEvents = async () => {
  ...
  _events = await sanityClient.fetch(
    `*[_type == "type_event" && !isPrivate && dateTime >= now()]{${eventQuery}} | order(dateTime)`
  );
  return _events;
};
...
export const getLocations = async () => {
  ...
  _locations = await sanityClient.fetch(
    `*[_type == "type_location"]{${locationsQuery}} | order(orderRank)`
  );
  return _locations;
};
...
const careersResponse = await fetch(
  "https://api.rippling.com/platform/api/ats/v1/board/domaine-careers/jobs"
);
