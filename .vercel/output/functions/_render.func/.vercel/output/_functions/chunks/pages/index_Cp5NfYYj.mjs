import 'html-escaper';
import 'cssesc';
import { e as createAstro, f as createComponent, r as renderTemplate, h as addAttribute, m as maybeRenderHead, i as renderComponent, j as renderSlot, k as renderHead, l as createTransitionScope } from '../astro_DqcxPQpM.mjs';
import 'kleur/colors';
import 'clsx';
/* empty css                          */
/* empty css                          */
...
const $$Header = createComponent(async ($$result, $$props, $$slots) => {
  ...
  })} </nav> </span> <a class="button contact-button"${addAttribute(data[0].buttonURL, "href")} data-astro-cid-rxbhrqfy> ${data[0].buttonText} ${renderComponent($$result, "Icon", $$Icon, { "glyph": "email", "size": "large", "data-astro-cid-rxbhrqfy": true })} </a> </header>  `;
...
const $$HeaderMobile = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const data = await getHeaderContent();
  return renderTemplate`${maybeRenderHead()}<header class="header" data-animate="true" data-astro-cid-elvhc56x> <a class="logo" href="/" aria-label="Domaine homepage" data-astro-cid-elvhc56x> ${renderComponent($$result, "Icon", $$Icon, { "glyph": "logo", "data-astro-cid-elvhc56x": true })} </a> <a class="button contact-button"${addAttribute(data[0].buttonURL, "href")} data-astro-cid-elvhc56x> ${renderComponent($$result, "Icon", $$Icon, { "glyph": "email", "size": "large", "data-astro-cid-elvhc56x": true })} </a> </header> <div class="navigation" data-astro-cid-elvhc56x> <nav class="navigation-links" data-astro-cid-elvhc56x> ${data[0].links.map((link, i) => {
    return renderTemplate`<a class="navigation-link"${addAttribute(link.linkURL, "href")} data-astro-cid-elvhc56x>${link.linkText}</a>`;
  })} </nav> </div>  `;
}, "/Users/treyhardin/Documents/Working Files/Domaine/domaine-client/src/components/sections/header/HeaderMobile.astro", void 0);
...
const $$CategoryTag = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<a class="category-tag button caption"${addAttribute(`/insights/${category.slug.current}`, "href")} data-astro-cid-prtur4gd>${category.name}</a> `;
...
const $$BlogIndexHero = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="blog-index-hero" data-astro-cid-kkuqwvpk> <div class="media" data-astro-cid-kkuqwvpk> <img class="post-image" sizes="(max-width: 768px) 100vw, 50vw"${addAttribute(`
      ...
      `, "srcset")}${addAttribute(urlFor(content.post.mainImage).url(), "src")} data-astro-cid-kkuqwvpk${addAttribute(createTransitionScope($$result, "eyy7vdel"), "data-astro-transition-persist")}> </div> <div class="text" data-astro-cid-kkuqwvpk> <div class="section-title" data-astro-cid-kkuqwvpk> <h1 class="h5 heading" data-astro-cid-kkuqwvpk>${content.heading}</h1> <h2 class="caption subheading" data-astro-cid-kkuqwvpk>${content.subheading}</h2> </div> <div class="post-content" data-astro-cid-kkuqwvpk> <div class="post-title" data-astro-cid-kkuqwvpk> <a${addAttribute(`/insights/${content.post.category.slug.current}/${content.post.slug.current}`, "href")} data-astro-cid-kkuqwvpk> <h3 class="h1" data-astro-cid-kkuqwvpk>${content.post.title}</h3> </a> ${renderComponent($$result, "CategoryTag", $$CategoryTag, { "category": content.post.category, "data-astro-cid-kkuqwvpk": true })} </div> <div class="post-details" data-astro-cid-kkuqwvpk> <h4 class="h6" data-astro-cid-kkuqwvpk>${content.post.excerpt}</h4> <a class="button"${addAttribute(`/insights/${content.post.category.slug.current}/${content.post.slug.current}`, "href")} data-astro-cid-kkuqwvpk>Read More</a> </div> </div> </div> </section> `;
}, "/Users/treyhardin/Documents/Working Files/Domaine/domaine-client/src/components/sections/blog/blogIndex/BlogIndexHero.astro", "self");
...
const $$BlogIndexSidebar = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<aside class="blog-index-sidebar" data-astro-cid-e4saslip> <a class="sidebar-link"${addAttribute(activeCategory ? "false" : "true", "data-active")}${addAttribute(`/insights`, "href")} data-astro-cid-e4saslip>All Insights</a> ${content.map((category, i) => {
...
const $$Services = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section class="services" data-astro-cid-y4wgi45u> <div class="section-main" data-astro-cid-y4wgi45u> <div class="section-title" data-astro-cid-y4wgi45u> ${content.heading && renderTemplate`<h2 class="h2 heading" data-astro-cid-y4wgi45u>${content.heading}</h2>`} ${content.subheading && renderTemplate`<h3 class="h5 subheading" data-astro-cid-y4wgi45u>${content.subheading}</h3>`} </div> <div class="media" data-astro-cid-y4wgi45u> ${content.services.map((service, i) => {
    ...
    return renderTemplate`${renderComponent($$result, "ViewportObserver", null, { "client:only": "solid-js", "client:component-hydration": "only", "data-astro-cid-y4wgi45u": true, "client:component-path": "/Users/treyhardin/Documents/Working Files/Domaine/domaine-client/src/animation/ViewportObserver", "client:component-export": "default" }, { "default": ($$result2) => renderTemplate` <div class="detail-block"${addAttribute(i, "data-index")} data-astro-cid-y4wgi45u> <img class="service-image-mobile" sizes="100vw"${addAttribute(`
              ...
              `, "srcset")}${addAttribute(urlFor(service.image).width(800).height(800).auto("format").url(), "src")} width="100vw" height="100vw" data-astro-cid-y4wgi45u> ${service.title && renderTemplate`<h4 data-astro-cid-y4wgi45u>${service.title}</h4>`} ${service.description && renderTemplate`<h5 class="h6" data-astro-cid-y4wgi45u>${service.description}</h5>`} <ul class="deliverables" data-astro-cid-y4wgi45u> ${service.deliverables && service.deliverables.map((deliverable) => {
      return renderTemplate`<li class="deliverable" data-astro-cid-y4wgi45u>${deliverable}</li>`;
    })} </ul> </div> ` })}`;
  })} </div> </section>  `;
...
const $$file$1 = "/Users/treyhardin/Documents/Working Files/Domaine/domaine-client/src/pages/index.astro";
const $$url$1 = "";
...
const $$file = "/Users/treyhardin/Documents/Working Files/Domaine/domaine-client/src/pages/events/index.astro";
const $$url = "/events";
...
export { $$Header as $, $$Icon as a, $$Layout as b, $$BlogIndexHero as c, $$BlogIndexSidebar as d, $$BlogIndexFeed as e, $$CategoryTag as f, getBlogPageContent as g, getBlogPosts as h, getEvents as i, $$SectionBlock as j, getPages as k, index$2 as l, index$1 as m, index as n, urlFor as u };
